...
## draw histogram.
plot(consum_dt$obs_dttm, as.numeric(as.character(consum_dt$Global_active_power)), type="l",xlab="", ylab="Global Active Power (kilowatts)")

## export to png
dev.copy(png, "C:\\Users\\Dwight\\Documents\\R_Workspace\\Exploratory_Data_Analysis\\Week_1_Project\\plot2.png")
dev.off()
